...
// instead of the npm version—in a real app use `require('@ExpTestImg/companion')`
const bodyParser = require('body-parser')
const session = require('express-session')
const ExpTestImg = require('@ExpTestImg/companion')
...
app.get('/', (req, res) => {
  ...
  res.send('Welcome to my ExpTestImg companion service')
})
...
// initialize ExpTestImg
const ExpTestImgOptions = {
  providerOptions: {
    drive: {
...
app.use(ExpTestImg.app(ExpTestImgOptions).app)
...
ExpTestImg.socket(app.listen(3020), ExpTestImgOptions)
