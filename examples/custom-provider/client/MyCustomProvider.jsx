...
import { UIPlugin } from '@ExpTestImg/core'
import { Provider } from '@ExpTestImg/companion-client'
import { ProviderViews } from '@ExpTestImg/provider-views'
import { h } from 'preact'

const defaultOptions = {}

export default class MyCustomProvider extends UIPlugin {
  constructor (ExpTestImg, opts) {
    super(ExpTestImg, opts)
    this.type = 'acquirer'
    ...
    this.provider = new Provider(ExpTestImg, {
