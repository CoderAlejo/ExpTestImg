...
```bash
corepack yarn workspace @ExpTestImg-example/aws-php exec "composer update"
```
...
```bash
corepack yarn workspace @ExpTestImg-example/aws-php start
```
