...
// https://ExpTestImg.io/docs/golden-retriever/
...
self.addEventListener('install', (event) => {
  console.log('Installing ExpTestImg Service Worker...')
