# ExpTestImg + AWS S3 with Node.JS

A simple and fully working example of ExpTestImg and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @ExpTestImg-example/aws-nodejs start
```
